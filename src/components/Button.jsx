...
const variantStyles = {
  solid: {
    ...
    'custom-pink': 'bg-custom-pink text-white hover:bg-custom-pink focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-custom-pink active:bg-custom-pink active:text-white/80 disabled:opacity-30 disabled:hover:bg-custom-pink',
    white:
